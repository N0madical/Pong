...
bounceunc = 0  # Uncertainty of Ball Bounce (deg) (0 = Perfect Physics) (180 = 100% uncertainty)
...
while running:
    ...
    if (colpoint != []) and (bounce == False):
        ...
        if bounceunc > 0:
            ...
            print([int(math.floor(0-(bounceunc/2))),int(math.ceil(0+(bounceunc/2)))])
        else:
